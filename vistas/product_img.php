   ...
   ?>
	...
	<div class="columns">
		...
		<div class="column is-two-fifths">
			...
			<form class="FormularioAjax" action="./php/pro_eliminar_imagen.php" method="POST" autocomplete="off" >
		...
		<div class="column">
			<form class="mb-6 has-text-centered FormularioAjax" action="./php/pro_actualizar_imagen.php" method="POST" enctype="multipart/form-data" autocomplete="off" >
