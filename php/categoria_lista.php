...
if(isset($busqueda) && $busqueda!=""){
    ...
    $consulta_datos="SELECT * FROM categoria WHERE categoria_nombre LIKE '%$busqueda%' OR categoria_ubicacion LIKE '%$busqueda%' ORDER BY categoria_nombre ASC LIMIT $inicio,$registro";
...
$tabla.='
    <p class="has-text-right">Mostrando categorias <strong>'.$paginado_inico.'</strong> al <strong>'.$paginado_final.'</strong> de un <strong>total de '.$total.'</strong></p>
';
